...
export type { SquircleParams, SquircleViewProps, GradientParams, LinearGradientParams, RadialGradientParams, GradientStop, MaybeAnimated, AnimatedSquircleParams, AnimatedSquircleViewProps, } from './types';
